...
Данный проект содержит 5 bash-скриптов, предназначенных для выполнения конкретных задач по обработке файловой системы преподователя предметов Криптозоология и Пивоварение.
